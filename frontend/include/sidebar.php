<!-- Wrapper to hold sidebar + main -->
<div style="display: flex; min-height: 100vh; overflow: hidden;">

  <!-- Sidebar -->
  <nav id="sidebar" class="sidebar d-flex flex-column p-4 text-white" style="
    background: rgba(63, 193, 240, 0.5) !important;
  ...
  ">
    ...
    <a href="guardianuser/index.php" class="btn text-start mb-2 w-100 d-flex align-items-center text-white" style="background-color: transparent; border: none; font-size: 20px;">
      UserProfile 
    </a>
  </nav>
